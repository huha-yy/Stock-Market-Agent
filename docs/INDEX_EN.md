...
| [Market Radar](market-radar.md) | Current A-share Phase 2A snapshots, two-stage enrichment, deterministic scoring, data quality, persisted replay, and scope boundaries |
