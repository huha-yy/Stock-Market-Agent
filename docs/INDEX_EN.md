...
| [Market Radar](market-radar.md) | Manual A-share sector snapshots, deterministic scoring, data quality, persistence, replay foundation, and current Phase 1 boundaries |
