...
| [Market Radar](market-radar.md) | A-share Phase 2C snapshots, ETF and position policy, read-only API and Web monitoring cockpit, data quality, persisted replay, and scope boundaries |
